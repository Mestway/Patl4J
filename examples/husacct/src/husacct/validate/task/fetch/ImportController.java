...
public class ImportController {
	...
	public void importWorkspace(Element element) throws DatatypeConfigurationException { 
		importSeverties(element.element("severities")); 

		importSeveritiesPerTypesPerProgrammingLanguages(element.element("severitiesPerTypesPerProgrammingLanguages")); 
		importActiveViolationTypes(element.element("activeViolationTypes")); 

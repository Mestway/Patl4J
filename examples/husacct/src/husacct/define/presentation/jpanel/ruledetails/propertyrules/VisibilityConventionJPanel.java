...
public class VisibilityConventionJPanel extends AbstractDetailsJPanel {
	...
	public void initDetails() {
		moduleFromPanelComponent = new ModuleFromPanelComponent(isException, appliedRuleController);
		...
		this.add(descriptionPanelComponent, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	}

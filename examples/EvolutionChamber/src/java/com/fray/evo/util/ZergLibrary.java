...
public final class ZergLibrary {
  static private ArrayList<Buildable> createList(  Buildable... buildables){
    java.util.List<com.fray.evo.util.Buildable> genVar4620;
    genVar4620=Arrays.asList(buildables);
    java.util.ArrayList<com.fray.evo.util.Buildable> genVar4621;
    genVar4621=new ArrayList<Buildable>(genVar4620);
    return genVar4621;
  }

...
public final class TerranLibrary {
  static private ArrayList<Buildable> createList(  Buildable... buildables){
    java.util.List<com.fray.evo.util.Buildable> genVar4470;
    genVar4470=Arrays.asList(buildables);
    java.util.ArrayList<com.fray.evo.util.Buildable> genVar4471;
    genVar4471=new ArrayList<Buildable>(genVar4470);
    return genVar4471;
  }

...
public final class ProtossLibrary {
  static private ArrayList<Buildable> createList(  Buildable... buildables){
    java.util.List<com.fray.evo.util.Buildable> genVar4680;
    genVar4680=Arrays.asList(buildables);
    java.util.ArrayList<com.fray.evo.util.Buildable> genVar4681;
    genVar4681=new ArrayList<Buildable>(genVar4680);
    return genVar4681;
  }

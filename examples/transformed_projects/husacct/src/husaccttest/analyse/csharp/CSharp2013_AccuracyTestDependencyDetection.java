...
public class CSharp2013_AccuracyTestDependencyDetection {
	...
	private static String path = new File(TestResourceFinder.findSourceCodeDirectory("csharp", "benchmark")).getAbsolutePath();
...
//	From: InheritanceExtendsExtendsIndirect
	...
	private static void setLog4jConfiguration() {
		...
		logger = Logger.getLogger(CSharp2013_AccuracyTestDependencyDetection.class);
	}
